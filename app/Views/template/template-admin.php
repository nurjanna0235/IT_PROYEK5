...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/template_admin/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="/template_admin/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="/template_admin/plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="/template_admin/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="/template_admin/plugins/jquery-ui/jquery-ui.min.js"></script>
    ...
    <!-- Sparkline -->
    <script src="/template_admin/plugins/sparklines/sparkline.js"></script>
    <!-- JQVMap -->
    <script src="/template_admin/plugins/jqvmap/jquery.vmap.min.js"></script>
    <script src="/template_admin/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="/template_admin/plugins/jquery-knob/jquery.knob.min.js"></script>
    <!-- daterangepicker -->
    ...
    <!-- overlayScrollbars -->
    <script src="/template_admin/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <!-- AdminLTE App -->
    <script src="/template_admin/dist/js/adminlte.js"></script>
